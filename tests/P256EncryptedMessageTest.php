...
class P256EncryptedMessageTest extends TestCase
{
    ...
    public function testThatGetCypherIsExactlyWithPadLenght()
    {
        $expected = 3070;
    ...
    public function testGetContentEncryptionKey()
    {
    ...
    public function testGetPseudoRandomKey()
    {
    ...
    public function testGetEncodedSalt()
    {
    ...
    public function testGetEncodedPrivateKey()
    {
    ...
    public function testGetEncodedPublicKey()
    {
